...
import { createPluginAction } from './actions/plugin.js';
import { createMiddlewareAction } from './actions/middleware.js';
import { createModuleAction } from './actions/module.js';
...
program
  ...
  .option(
    '--use <service|model>',
    'Prefer using service create function when present',
    'service',
  )
