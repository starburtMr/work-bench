...
This app is the Python backend example for the FastAPI Clean Architecture and DDD template.
It uses FastAPI, SQLAlchemy, Alembic, Pydantic Settings, Loguru, JWT cookies, and `uv`.
