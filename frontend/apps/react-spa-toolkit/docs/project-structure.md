...
This approach keeps the skeleton adaptable after it is copied into a real project. Replace the demo features gradually while preserving the app -> features -> shared dependency direction.
