...
[Unit Test Example Code](../src/components/seo/__tests__/head.test.tsx)
...
[Integration Test Example Code](../src/features/auth/components/__tests__/login-form.test.tsx)
