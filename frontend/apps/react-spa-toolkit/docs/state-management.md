...
Application state examples in this skeleton are intentionally lightweight. Add feature-local stores only when component state and server cache state are insufficient.
