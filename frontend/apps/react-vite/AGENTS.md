...
This app is the React + Vite implementation of Bulletproof React.
It is a client-side SPA built with React 18, TypeScript, Vite, React Router, TanStack Query, Zustand, React Hook Form, MSW, Storybook, and Playwright.
